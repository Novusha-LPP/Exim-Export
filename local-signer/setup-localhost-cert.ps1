...
if (-not (Test-Path $CertPath)) {
    ...
    Write-Host "[OK] Certificate exported successfully!" -ForegroundColor Green
} else {
    Write-Host "[OK] Certificate already exported." -ForegroundColor Green
}
...
Write-Host "[OK] localhost.jks is created and trusted." -ForegroundColor Green
Write-Host "==========================================" -ForegroundColor Green
