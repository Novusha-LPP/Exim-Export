...
const styles = {
  ...
  select: {
    width: "100%", fontSize: 12, padding: "3px 6px", border: "1px solid #bdc7d1",
    borderRadius: 3, height: 26, background: "#f7fafc", outline: "none", boxSizing: "border-box",
    textTransform: "uppercase", fontWeight: 600
  },
...
function CFSDropdownField({ label, fieldName, formik, cfsList, placeholder = "ENTER WAREHOUSE CODE" }) {
          ...
          <div style={styles.acMenu}>
            {filtered.map((item, i) => {
              ...
              return (
                ...
                >
                  {toUpper(code)}
                  {name && <span style={{ marginLeft: 6, color: "#667" }}> - {toUpper(name)}</span>}
                </div>
              );
            })}
          </div>
              ...
              <div style={styles.half}>
                ...
                >
                  ...
                  {goodsStuffedAtOptions.map(opt => (
                    <option key={opt} value={opt}>{toUpper(opt)}</option>
                  ))}
                </select>
              </div>
              <div style={styles.half}>
...
/>
            ...
            <div style={styles.field}>
              ...
              <textarea
                ...
                onChange={e => handleFieldChange("factory_address", e.target.value.toUpperCase())}
 ...
 <div style={styles.field}>
              <div style={styles.label}>WAREHOUSE CODE (OF CFS/ICD/TERMINAL)</div>
              <input
                style={styles.input}
                value={toUpper(formik.values.warehouse_code || "")}
                onChange={e => handleFieldChange("warehouse_code", e.target.value.toUpperCase())}
                placeholder="ENTER WAREHOUSE CODE"
              />
            </div>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.field}>
              ...
              <input
                ...
                onChange={e => handleFieldChange("stuffing_seal_no", e.target.value.toUpperCase())}
            ...
            <div style={styles.field}>
              ...
              <input
                ...
                onChange={e => handleFieldChange("stuffing_agency_name", e.target.value.toUpperCase())}
                placeholder="ENTER AGENCY NAME"
              />
            </div>

            {/* Additional Information */}
            <div style={{ ...styles.sectionTitle, marginTop: 10 }}>ADDITIONAL INFORMATION</div>
            ...
            <div style={styles.field}>
              ...
              <input
                ...
                onChange={e => handleFieldChange("stuffing_supervisor", e.target.value.toUpperCase())}
            ...
            <div style={styles.field}>
              ...
              <textarea
                ...
                onChange={e => handleFieldChange("stuffing_remarks", e.target.value.toUpperCase())}
