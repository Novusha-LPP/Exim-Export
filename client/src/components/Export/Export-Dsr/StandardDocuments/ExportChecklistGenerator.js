              ...
              if (deec.deecItems && deec.deecItems.length > 0) {
                deec.deecItems.forEach((item, itemIdx) => {
                  deecRows.push({
                    ...
                    rawMaterial: item.description || "",
                    quantity: `${item.quantity || 0} ${item.unit || "MTS"}`,
                    exportQuantity: `${deec.exportQtyUnderLicence || 0} ${deec.exportQtyUnit || item.unit || "MTS"}`,
                ...
                deecRows.push({
                  ...
                  itemSnoPartE: deec.itemSnoPartE || "",
                  rawMaterial: "",
                  quantity: `0 ${deec.exportQtyUnit || "MTS"}`,
                  exportQuantity: `${deec.exportQtyUnderLicence || 0} ${deec.exportQtyUnit || "MTS"}`,
              ...
              if (epcg.epcgItems && epcg.epcgItems.length > 0) {
                epcg.epcgItems.forEach((item, itemIdx) => {
                  epcgRows.push({
                    ...
                    rawMaterial: item.description || "",
                    quantity: `${item.quantity || 0} ${item.unit || "MTS"}`,
                    exportQuantity: `${epcg.exportQtyUnderLicence || 0} ${epcg.exportQtyUnit || item.unit || "MTS"}`,
                    indigenousImported: item.itemType || "Imported",
                    invNo: invNo || "1",
                    itemNo: itemNo,
                  });
                ...
                epcgRows.push({
                  ...
                  itemSnoPartE: epcg.itemSnoPartE || "",
                  rawMaterial: "",
                  quantity: `0 ${epcg.exportQtyUnit || "MTS"}`,
                  exportQuantity: `${epcg.exportQtyUnderLicence || 0} ${epcg.exportQtyUnit || "MTS"}`,
                  indigenousImported: "Imported",
                  invNo: invNo || "1",
                  itemNo: itemNo,
                });
