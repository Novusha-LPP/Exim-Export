...
const AnalyticsDashboard = () => {
  ...
  if (loading)
    return <div className="open-points-container">Loading Analytics...</div>;
    ...
    <div className="open-points-container">
      ...
      <div className="project-grid" style={{ marginTop: "20px" }}>
        <div
          ...
          style={{ textAlign: "center", borderTop: "4px solid #ef4444" }}
        >
        ...
        <div
          className="premium-card"
          style={{ textAlign: "center", borderTop: "4px solid #f59e0b" }}
        >
          <h1 style={{ fontSize: "3rem", color: "#f59e0b" }}>
            {getCount("Yellow") + getCount("Orange")}
          </h1>
          <p>In Progress / New</p>
        </div>
        <div
          className="premium-card"
          style={{ textAlign: "center", borderTop: "4px solid #10b981" }}
        >
      ...
      <div className="premium-card" style={{ marginTop: "24px" }}>
        ...
        <p>
          Detailed aging charts would go here (requires chart.js or similar).
        </p>
        <div
          style={{
            height: "200px",
