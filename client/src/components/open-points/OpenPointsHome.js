...
const OpenPointsHome = () => {
  ...
  const totalMyTasks = projects.reduce(
    (acc, p) => acc + (p.myStats?.total || 0),
    0
  );
  const totalMyPending = projects.reduce(
    (acc, p) => acc + (p.myStats?.red || 0) + (p.myStats?.yellow || 0),
    0
  );

  return (
    <div
      className="open-points-page"
      style={{
        width: "100%",
        minHeight: "100vh",
        background: "#ffffff",
      ...
      >
        ...
        >
          <div>
            ...
            <p
              style={{ color: "#64748b", fontSize: "1.1rem", marginTop: "5px" }}
            >
                ...
                >
                  {paginatedProjects.map((project) => (
                    <div
                      ...
                      className="glass-card"
                      onClick={() =>
                        navigate(`/open-points/project/${project._id}`)
                      }
                      style={{
                        cursor: "pointer",
                    ...
                    >
                      ...
                      <div style={{ marginBottom: "24px" }}>
                        ...
                        >
                          <div
                            style={{
                              width: `${
                                (project.stats?.green / project.stats?.total) *
                                100
                              }%`,
                          ...
                          <div
                            style={{
                              width: `${
                                (project.stats?.yellow / project.stats?.total) *
                                100
                              }%`,
                          ...
                          <div
                            style={{
                              width: `${
                                (project.stats?.orange / project.stats?.total) *
                                100
                              }%`,
                          ...
                          <div
                            style={{
                              width: `${
                                (project.stats?.red / project.stats?.total) *
                                100
                              }%`,
                      ...
                      >
                        ...
                        {/* My Pending Badge */}
                        {(project.myStats?.red > 0 ||
                          project.myStats?.yellow > 0) && (
                          <span
                            style={{
                              background: "#fee2e2",
                              color: "#ef4444",
                          ...
                          >
                            {project.myStats.red + project.myStats.yellow}{" "}
                            Pending
                          </span>
                        )}
                      </div>
