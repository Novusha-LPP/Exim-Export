...
const Feedback = () => {
  ...
  const fetchFeedback = async () => {
    ...
    try {
      ...
      const response = await axios.get(`${import.meta.env.VITE_API_STRING}/feedback?${params.toString()}`);
  ...
  const fetchMyFeedback = async () => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_API_STRING}/feedback/user/${user.username}`);
      if (response.data?.success) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${import.meta.env.VITE_API_STRING}/feedback`, submitData);
      if (response.data?.success) {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await axios.delete(`${import.meta.env.VITE_API_STRING}/feedback/${id}`);
      if (response.data?.success) {
