...
router.get("/api/operation-jobs/:status?", async (req, res) => {
    try {
        ...
        const selectProjection = {
            ...
            egm_no: 1, egm_date: 1, exchange_rate: 1, freight: 1, insurance: 1, discount: 1, other_deduction: 1, commission: 1,
            invoices: 1,
            ...
            "containers.containerSize": 1,
            "containers.container_type": 1,
            "containers.containerType": 1,
            "containers.type": 1,
            "containers.size": 1,
            "containers.cntr_size": 1,
            "containers.cntr_type": 1,
            "containers.isoCode": 1,
            "containers.seal_no": 1,
            "containers.images": 1,
