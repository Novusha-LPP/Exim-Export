...
import emptyYardCodes from "./routes/Directories/emptyYardDirectory.js";
...
import transportData from "./routes/export-dsr/transportData.mjs";
...
import virtualBalanceRoutes from "./routes/export-dsr/virtualBalanceRoutes.mjs";
import getTabCounts from "./routes/export-dsr/getTabCounts.mjs";
...
import clubJobRoutes from "./routes/export-dsr/clubJobRoutes.mjs";
...
import { initFreightAutoRejectCronJob, freightAutoRejectRouter } from "./jobs/freightAutoRejectJob.mjs"; // Freight Auto-Reject Stale Enquiries
...
app.use(cfsCodes);
app.use("/api/emptyYardCodes", auditMiddleware("Directory"), emptyYardCodes);
app.use(emptyYardCodes);
...
app.use(getTabCounts);
app.use("/api", clubJobRoutes);
...
app.use(freightAutoRejectRouter);
...
initFreightAutoRejectCronJob(); // Hourly Freight Auto-Reject job for stale inquiries (> 5 days)
